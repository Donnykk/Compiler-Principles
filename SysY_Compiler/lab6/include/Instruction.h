...
class AllocaInitInstruction : public Instruction
{
public:
    Operand *src;
    AllocaInitInstruction(Operand *src, Operand *dst, SymbolEntry *se, BasicBlock *insert_bb = nullptr);
    ~AllocaInitInstruction();
    void output() const;
