...
public:
    IdentifierSymbolEntry(Type *type, std::string name, int scope, int param_index = -1, bool isSysY = false);
    virtual ~IdentifierSymbolEntry(){};
    std::string toStr();
    bool isGlobal() const { return scope == GLOBAL; };
    bool isParam() const { return scope == PARAM; };
    bool isLocal() const { return scope >= LOCAL; };
    bool isSysy() const { return isSysY; };
    int getScope() const { return scope; };
    void setAddr(Operand *addr) { this->addr = addr; };
    Operand *getAddr() { return addr; };
    void setValue(int value);
    int getValue() const { return value; };
    void setArrayValue(int *arr_val);
    int *getArrayValue() const { return arr_val; };
    int getLabel() const { return label; };
    void setLabel() { label = SymbolTable::getLabel(); };
    void setInitZero() { init_zero = true; };
    bool isInitZero() const { return init_zero; };
    int getParamNo() const { return param_index; };
